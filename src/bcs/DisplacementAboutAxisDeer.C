...
InputParameters
DisplacementAboutAxisDeer::validParams()
{
...
void
addDisplacementAboutAxisDeerParams(InputParameters & params)
{
  MooseEnum units("degrees radians");
  params.addRequiredParam<FunctionName>("function",
                                        "The function providing the total angle of rotation or the "
                                        "angular velocity.");
...
DisplacementAboutAxisDeer::DisplacementAboutAxisDeer(const InputParameters & parameters)
...
void
DisplacementAboutAxisDeer::initialSetup()
{
...
Real
DisplacementAboutAxisDeer::computeQpValue()
{
...
ColumnMajorMatrix
DisplacementAboutAxisDeer::rotateAroundAxis(const ColumnMajorMatrix & p0, const Real angle)
{
...
void
DisplacementAboutAxisDeer::calculateUnitDirectionVector()
{
...
void
DisplacementAboutAxisDeer::calculateTransformationMatrices()
{
