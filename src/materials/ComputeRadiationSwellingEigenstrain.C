...
InputParameters
ComputeRadiationSwellingEigenstrain::validParams()
{
...
void
ComputeRadiationSwellingEigenstrain::initQpStatefulProperties()
{
...
void
ComputeRadiationSwellingEigenstrain::computeQpEigenstrain()
{
  // Update dose
