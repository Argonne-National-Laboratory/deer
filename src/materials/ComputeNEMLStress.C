...
ComputeNEMLStress::ComputeNEMLStress(const InputParameters &parameters)
    : DerivativeMaterialInterface<Material>(parameters),
      ...
      _mechanical_strain_unrotated(
          getMaterialPropertyByName<RankTwoTensor>("mechanical_strain_unrotated")),
      ...
      _mechanical_strain_unrotated_old(
          getMaterialPropertyOldByName<RankTwoTensor>("mechanical_strain_unrotated")),
      ...
      _inelastic_strain_unrotated(declareProperty<RankTwoTensor>("inelastic_strain_unrotated")) {
